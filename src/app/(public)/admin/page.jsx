...
export default function AdminPage() {
  ...
  if (admin.loading) return (
    <div style={{ minHeight: "70vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 22, fontFamily: fonts.body, background: "#fff" }}>
      ...
      <p style={{ margin: 0, fontFamily: "'Instrument Sans', 'Manrope', sans-serif", fontSize: 11, letterSpacing: 2, textTransform: "uppercase", color: "#686E78" }}>Dashboard wird geladen</p>
      <style>{`
        @keyframes adminHex {
