...
export default function ProfilePage() {
  ...
  if (loading) return <div style={{ fontFamily: fonts.body, padding: 60, textAlign: "center", color: "#5B626C" }}>Lade Profil...</div>;
  if (!profile) return <div style={{ fontFamily: fonts.body, padding: 60, textAlign: "center", color: "#5B626C" }}>Profil nicht gefunden</div>;
