...
const card = { background: "#fff", border: "1px solid #1D1D1D", borderRadius: 20, padding: "24px 26px" };
    ...
    <div style={{ background: PAPER, minHeight: "100vh" }}>
      <div className="bd-seite-schmal">
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
            {IMPORT_SOURCES.map((s) => (
              <span key={s.key} style={{
                ...
                border: `1px solid ${INK}1f`, borderRadius: 20, padding: "4px 9px", color: MUTED,
              }}>{s.label}</span>
            ))}
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 12, marginBottom: 28 }}>
          <div style={{ background: "#fff", border: `1px solid ${INK}1f`, borderRadius: 20, padding: "14px 16px" }}>
