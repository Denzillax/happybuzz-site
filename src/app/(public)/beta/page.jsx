...
const TESTS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "home_fakten_chips", label: "Startseite: vier Fakten-Kacheln unter dem Hero (am Handy wischbar) und die Reihe 'Entdecken'. 'Unter CHF 20' öffnet die Suche mit gesetzter Preisgrenze, 'Endet bald' zeigt Auktionen nach Restzeit, 'Mit Versand' setzt den Lieferfilter" },
      { id: "home_kat_foto", label: "Startseite: Kategorie-Pillen zeigen ein rundes Foto des neusten Inserats, leere Kategorien ihr Symbol" },
