...
const TESTS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "sell_auktion_gesperrt", label: "Auktion mit Gebot bearbeiten: gelber Hinweis oben, Titel/Preise/Dauer/Typ/Kategorie/Zustand ausgegraut, Beschreibung nur lesbar mit Feld 'Nachtrag' (landet mit Datum unter dem Text), Fotos entfernen gesperrt, neue Fotos gehen; auf Meine Inserate heisst der Knopf 'Eingeschränkt'" },
