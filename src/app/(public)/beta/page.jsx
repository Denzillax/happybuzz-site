...
const TESTS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "lc_import_tutti", label: "Import: Tutti-Link einfügen füllt Titel, Beschreibung, Preis + nur die EIGENEN Galeriebilder (keine Bilder aus 'Ähnliche Inserate'); alles danach editierbar" },
      { id: "lc_import_fallback", label: "Import: bei geblockten Plattformen (Ricardo/eBay/FB) erscheint der Kopieren-und-Einfügen-Fallback mit Anleitung; eingefügte Seite füllt das Formular" },
      { id: "lc_import_guard", label: "Import: fremde Links (nicht Ricardo/Tutti/eBay/FB) werden abgelehnt; Import-Box nur beim Erstellen sichtbar, nicht beim Bearbeiten" },
