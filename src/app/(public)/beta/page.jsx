...
const TESTS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "chat_loeschen", label: "Nachrichten-Tab: Gespräch entfernen (Desktop: Papierkorb beim Drüberfahren, Handy: nach links wischen); unter 'Ausgeblendete Gespräche' wiederherstellen; Gespräch zu verkauftem Inserat ist ausgegraut mit Chip 'Verkauft'" },
