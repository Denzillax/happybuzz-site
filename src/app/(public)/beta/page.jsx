...
const TESTS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "home_fakten_chips", label: "Startseite: schmale Fakten-Zeile unter dem Hero und vier Schnelleinstiege unter den Kategorien. 'Unter CHF 20' öffnet die Suche mit gesetzter Preisgrenze, 'Endet bald' zeigt Auktionen nach Restzeit, 'Mit Versand' setzt den Lieferfilter" },
