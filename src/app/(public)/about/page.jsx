      ...
      <div style={{ maxWidth: 940, margin: "0 auto", padding: "0 24px 88px" }}>
        ...
        <div className="about-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 36, margin: "56px 0", alignItems: "center" }}>
          ...
          <div style={{ position: "relative" }}>
            <div aria-hidden style={{ position: "absolute", inset: "16px -10px -10px 16px", border: "1px solid #E4E0D8", borderRadius: 10, transform: "rotate(2.5deg)", opacity: .25 }} />
            <div style={{ position: "relative", background: INK, color: PAPER, borderRadius: 10, padding: "30px 28px", transform: "rotate(-1.5deg)", border: "1px solid #E4E0D8" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", fontFamily: MONO, fontSize: 11, letterSpacing: ".08em", color: "rgba(251,248,242,0.7)", borderBottom: "1px solid rgba(251,248,242,0.2)", paddingBottom: 10, marginBottom: 16 }}>
                <span>№ 0001</span>
                <span style={{ background: HONEY, color: INK, padding: "3px 8px", borderRadius: 10, fontWeight: 700, fontSize: 10 }}>MANIFEST</span>
              </div>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(210px, 1fr))", gap: 14 }}>
            {VALUES.map((v, i) => (
              <div key={i} style={{ padding: 24, borderRadius: 10, background: "#fff", border: "1px solid #E4E0D8", textAlign: "center" }}>
                <div style={{ width: 48, height: 48, borderRadius: 10, margin: "0 auto 14px", display: "flex", alignItems: "center", justifyContent: "center", background: SAND, border: "1px solid #E4E0D8" }}>
        ...
        <div className="about-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 36, margin: "56px 0", alignItems: "center" }}>
          ...
          <div style={{ padding: "30px 28px", borderRadius: 10, background: SAND, border: "1px solid #E4E0D8" }}>
        ...
        {/* ── Bee-Impact Band ── */}
        <div style={{ padding: 34, borderRadius: 10, textAlign: "center", marginBottom: 56, background: INK, color: PAPER }}>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16, maxWidth: 640, margin: "0 auto" }}>
            <div style={{ textAlign: "center", padding: "24px 18px", borderRadius: 10, background: "#fff", border: "1px solid #E4E0D8" }}>
            ...
            <div style={{ textAlign: "center", padding: "24px 18px", borderRadius: 10, background: SAND, border: `1px dashed ${INK}66`, display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        <div id="jobs">
          ...
          <div style={{ padding: 32, borderRadius: 10, background: "#fff", border: "1px solid #E4E0D8", textAlign: "center" }}>
