      ...
      <>
        ...
        <Section title="ÖFFENTLICHES PROFIL" description="So sehen andere dich auf BEEDARO.">
          ...
          <div style={{
            ...
            background: "#fff", border: `1px solid ${K.ink}`, borderRadius: 10, marginBottom: 20,
          }}>
            <div style={{ position: "relative", cursor: "pointer" }} onClick={() => fileInputRef.current?.click()}>
              <div style={{
                width: 72, height: 72, borderRadius: 10, overflow: "hidden", border: `1px solid ${K.ink}`,
                background: profile?.avatar_url
                  ? `url(${profile.avatar_url}) center/cover`
                  : K.honey,
                display: "flex", alignItems: "center", justifyContent: "center",
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <div style={{
            ...
            <div style={{ width: 36, height: 36, borderRadius: 10, border: `1px solid ${K.ink}`, display: "flex", alignItems: "center", justifyContent: "center", background:emailVerified ? C.green : K.sand, color: emailVerified ? "#fff" : K.ink, flexShrink: 0 }}>
            ...
            {emailVerified ? (
              ...
              }} style={{ padding: "7px 14px", borderRadius: 10, border: `1px solid ${K.ink}`, background: K.honey, color: K.ink, fontSize: 12, fontWeight: 800, cursor: "pointer", fontFamily: "'Manrope', sans-serif", opacity: emailSending ? 0.5 : 1 }}>
          ...
          <div style={{
            ...
            <div style={{ width: 36, height: 36, borderRadius: 10, border: `1px solid ${K.ink}`, display: "flex", alignItems: "center", justifyContent: "center", background:phoneVerified ? C.green : K.sand, color: phoneVerified ? "#fff" : K.ink, flexShrink: 0 }}>
            ...
            {phoneVerified ? (
              ...
              <button onClick={() => setActiveTab("address")} style={{ padding: "7px 14px", borderRadius: 10, border: `1px solid ${K.ink}`, background: "#fff", color: K.ink, fontSize: 12, fontWeight: 800, cursor: "pointer", fontFamily: "'Manrope', sans-serif" }}>
                Hinterlegen
              </button>
            )}
          </div>
          ...
          <div style={{
            ...
            <div style={{ width: 36, height: 36, borderRadius: 10, border: `1px solid ${K.ink}`, display: "flex", alignItems: "center", justifyContent: "center", background:addressVerified ? C.green : K.sand, color: addressVerified ? "#fff" : K.ink, flexShrink: 0 }}>
          ...
          <div style={{
            ...
            <div style={{ width: 36, height: 36, borderRadius: 10, border: `1px solid ${K.ink}`, display: "flex", alignItems: "center", justifyContent: "center", background: idVerified ? C.green : profile?.id_document_url ? K.honey : K.sand, color: idVerified ? "#fff" : K.ink, flexShrink: 0 }}>
            ...
            {idVerified ? (
              ...
              <span style={{ fontSize: 9.5, fontWeight: 700, fontFamily: MONO, letterSpacing: ".08em", textTransform: "uppercase", padding: "4px 9px", borderRadius: 10, border: `1px solid ${K.ink}`, background: K.honey, color: K.ink }}>Wird geprüft</span>
            ) : (
              <label style={{ padding: "7px 14px", borderRadius: 10, border: `1px solid ${K.ink}`, background: K.honey, color: K.ink, fontSize: 12, fontWeight: 800, cursor: "pointer", fontFamily: "'Manrope', sans-serif", opacity: idUploading ? 0.5 : 1 }}>
        ...
        badge={
          profile?.city && profile?.postal_code && profile?.street ? (
            ...
            <span style={{
              ...
              background: K.honey, border: `1px solid ${K.ink}`, padding: "4px 9px", borderRadius: 10,
              display: "inline-flex", alignItems: "center", gap: 4,
        ...
        <div>
          ...
          <div style={{ position: "relative" }}>
            ...
            {addrResults.length > 0 && (
              <div style={{ position: "absolute", top: "100%", left: 0, right: 0, background: "#fff", border: `1px solid ${K.ink}`, borderRadius: 10, maxHeight: 200, overflowY: "auto", zIndex: 50, boxShadow: `4px 4px 0 ${K.ink}22` }}>
                {addrResults.map((r, i) => (
                  <div key={i} onClick={() => {
      ...
      >
        {savedAddresses.map((addr, i) => (
          <div key={addr.id} style={{
            padding: 14, borderRadius: 10, border: `1px solid ${K.ink}`,
              ...
              <>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  {extraAddrHits.length > 0 && (
                    <div style={{ position: "absolute", top: "100%", left: 0, right: 0, background: "#fff", border: `1px solid ${K.ink}`, borderRadius: 10, maxHeight: 160, overflowY: "auto", zIndex: 50, boxShadow: `4px 4px 0 ${K.ink}22` }}>
                ...
                <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
                  <button onClick={() => { setEditAddrIdx(null); setNewAddr({ label: "", company: "", first_name: "", last_name: "", street: "", postal_code: "", city: "" }); setExtraAddrHits([]); }}
                    style={{ flex: 1, padding: "10px", borderRadius: 10, border: `1px solid ${K.ink}`, background: "#fff", color: K.ink, fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "'Manrope', sans-serif" }}>Abbrechen</button>
                  <button onClick={async () => {
                  ...
                  }} style={{ flex: 1, padding: "10px", borderRadius: 10, border: `1px solid ${K.ink}`, background: K.honey, color: K.ink, fontSize: 13, fontWeight: 800, cursor: "pointer", fontFamily: "'Manrope', sans-serif" }}>Speichern</button>
                </div>
              </>
            ) : (
        ...
        {showAddAddr && editAddrIdx === null ? (
          <div style={{ padding: 16, borderRadius: 10, border: `1px solid ${K.ink}`, background: "#FBF1D2", marginBottom: 10 }}>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
              ...
              }} style={{ flex: 1, padding: "10px", borderRadius: 10, border: `1px solid ${K.ink}`, background: newAddr.label ? K.honey : "#ccc", color: K.ink, fontSize: 13, fontWeight: 800, cursor: newAddr.label ? "pointer" : "default", fontFamily: "'Manrope', sans-serif" }}>Hinzufügen</button>
            </div>
          </div>
        ) : editAddrIdx === null && (
