      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "32px 20px 80px" }}>
        ...
        {!loading && sales.length > 0 && (
          <div style={{ display: "flex", gap: 12, marginTop: 20, flexWrap: "wrap" }}>
            <div style={{ flex: 1, minWidth: 200, background: "#fff", borderRadius: 10, border: "1px solid #E4E0D8", padding: "16px 20px" }}>
            ...
            <div style={{ flex: 1, minWidth: 200, background: "#EEF4EC", borderRadius: 10, border: "1px solid #E4E0D8", padding: "16px 20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
