...
// Layout-Klassen bk-* in globals.css.
...
const F = {
  radius: 20, rand: "1px solid #1D1D1D", randFein: "1px solid rgba(29,29,29,.14)",
  rot: "#C62828", rotGrund: "#FFE2DE", rotZeile: "#FFF4F2",
  warn: "#8A5A00", warnGrund: "#FEE8B0",
  gruen: "#3D6B3C", gruenGrund: "#CEF6E8",
  neutral: "#F6F4EF", neutral2: "#ECE8E0",
  miete: "#D3F0FF", service: "#FFDFF9",
};
