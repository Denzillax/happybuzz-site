  ...
  return (
    <div style={{ fontFamily: BODY, background: PAPER, minHeight: "100vh", color: INK }}>
      ...
      <div style={{ maxWidth: 740, margin: "0 auto", padding: "40px 24px 80px" }}>
        <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #1D1D1D", padding: "30px 30px 22px" }}>
          ...
          <p style={S.p}>Wir verwenden deine Daten ausschliesslich für: Bereitstellung und Betrieb der Plattform, Abwicklung von Transaktionen, Kommunikation zwischen Nutzern, Verifizierung und Trust Level, Gebührenabrechnung, Sicherheit und Betrugsprävention sowie zur Verbesserung unseres Angebots. Zur Betriebsüberwachung sehen Administratoren in Echtzeit, welche angemeldeten Nutzer die Plattform gerade nutzen und in welchem Bereich sie sich befinden. Seitenaufrufe werden zudem zur Analyse protokolliert (Nutzer, Bereich, Zeitpunkt) und nach spätestens 90 Tagen automatisch gelöscht.</p>
