...
function Restzeit({ start, ende }) {
  ...
  return (
    <span className="wl-rest">
      {/* "Noch" nur auf breiten Karten, am Handy reicht der Platz für die Zeit allein */}
      <span className="wl-rest-zeit"><span className="wl-nur-breit">Noch </span>{text}</span>
        ...
        {endend.length > 0 && (
          <section className="wl-abschnitt">
            <div className="wl-abschnitt-kopf wl-auf">
              ...
              <h2 className="wl-h2">Die Uhr läuft. Wer zuletzt bietet, gewinnt.</h2>
