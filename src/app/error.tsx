    ...
    <div style={{ fontFamily: "'Instrument Sans', 'Manrope', sans-serif", background: "#FFFFFF", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", color: "#1D1D1D" }}>
      <div style={{ textAlign: "center", padding: "40px 20px", maxWidth: 480 }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          <button onClick={() => reset()} style={{ padding: "12px 28px", borderRadius: 20, background: "#FEE8B0", color: "#1D1D1D", fontSize: 14, fontWeight: 700, border: "none", cursor: "pointer", fontFamily: "'Instrument Sans', 'Manrope', sans-serif" }}>
            Nochmal versuchen
          </button>
