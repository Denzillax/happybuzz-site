    ...
    <div style={{ fontFamily: "'Instrument Sans', 'Manrope', sans-serif", background: "#FFFFFF", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", color: "#191615" }}>
      <div style={{ textAlign: "center", padding: "40px 20px", maxWidth: 480 }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          <button onClick={() => reset()} style={{ padding: "12px 28px", borderRadius: 12, background: "#F4C03F", color: "#191615", fontSize: 14, fontWeight: 700, border: "none", cursor: "pointer", fontFamily: "'Instrument Sans', 'Manrope', sans-serif" }}>
            Nochmal versuchen
          </button>
          <a href="/" style={{ display: "inline-flex", padding: "12px 28px", borderRadius: 999, border: "1.5px solid #E5E8EC", background: "#fff", color: "#191615", fontSize: 14, fontWeight: 700, textDecoration: "none", fontFamily: "'Instrument Sans', 'Manrope', sans-serif" }}>
            Zur Startseite
          </a>
        </div>
      </div>
