...
export const BEE_LEVELS = [
  { key: "starter",      name: "Entdecker",    minXp: 0,    color: "#5B626C", perk: "Willkommen im Schwarm" },
  ...
  { key: "queen",        name: "Queen Bee",    minXp: 2000, color: "#8A5A00", perk: "Shop-Name + Top-Platzierung" },
