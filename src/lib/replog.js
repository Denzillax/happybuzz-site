...
export const REP_LOG = [
  {
    ...
    punkte: [
      { typ: "neu", bereich: "Hive", text: "Zwei weitere Tagesspiele neben dem Wabenspiel, als Reiter im Block 'Tägliche Spiele': Bienenflug (Höher oder Tiefer mit Karten 1 bis 12, jeder Treffer hebt den Gewinn bis 6.5x, Mitnehmen jederzeit) und Blütenpaar (Memory mit 6 Paaren in 8 Zügen, ab 2 Paaren gibt es etwas zurück, 6 Paare bringen das Dreifache). Jedes Spiel einmal pro Tag, Einsatz 5/10/20 Pollen", melder: "Denis" },
