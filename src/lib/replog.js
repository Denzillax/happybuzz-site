...
export const REP_LOG = [
  {
    ...
    punkte: [
      ...
      { typ: "fix", bereich: "Import", text: "Import-Helfer: Umlaute (ä ö ü) kamen als Entity-Code oder gar nicht an, und der Text verlor seine Absätze. Benannte Entities werden jetzt aufgelöst, Zeilenumbrüche werden zu Absätzen", melder: "Christian" },
