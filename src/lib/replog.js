...
export const REP_LOG = [
  {
    ...
    punkte: [
      { typ: "fix", bereich: "Suche", text: "Im Suchfeld erschien beim Klick ein durchsichtiger gelber Schein innerhalb der Pille (doppelter Fokus-Rahmen), der ist weg. Und wer etwas tippt, das wörtlich nichts trifft (etwa 'retro games'), bekommt jetzt automatisch die KI-Suche nach der Bedeutung, mit Hinweis, statt einer leeren Seite", melder: "Denis" },
