...
export const REP_LOG = [
  {
    ...
    punkte: [
      ...
      { typ: "fix", bereich: "Startseite", text: "Hero auf dem Handy entschachtelt: Die grosse weisse Exponat-Karte füllte als erster Block fast den ganzen Bildschirm, jetzt kommt zuerst die Überschrift und die Karte folgt als kompakter, schräg aufgeklebter Sticker mit Luft drumherum", melder: "Denis" },
