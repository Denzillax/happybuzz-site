...
export const REP_LOG = [
  ...
  },
  {
    ...
    punkte: [
      ...
      { typ: "neu", bereich: "Inserat", text: "KI-Bildersuche: das Lupen-Symbol auf dem Artikelfoto zeigt ähnliche Inserate mit Begründung. Jetzt ohne Wartezeit: jedes Inserat bekommt beim Einstellen einmalig Bild-Merkmale (Art, Marke, Farbe, Material, Stil), der Klick vergleicht nur noch Merkmale", melder: "Denis" },
      ...
      { typ: "fix", bereich: "Design", text: "Alle Knöpfe und Links auf der ganzen Plattform reagieren jetzt auf Hover: helle und gelbe werden leicht dunkler, dunkle (Schwarz, Petrol) heller", melder: "Denis" },
    ],
  },
  {
    ...
    punkte: [
      ...
      { typ: "neu", bereich: "Suche", text: "KI-Suche direkt aus dem Suchfeld oben: Sparkles-Symbol antippen, der getippte Text wird übernommen und die KI legt los. Auch mobil: in der Such-Pille und in der Suchzeile", melder: "Denis" },
