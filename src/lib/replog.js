...
export const REP_LOG = [
  {
    ...
    punkte: [
      ...
      { typ: "neu", bereich: "Startseite", text: "Sechs Neuerungen: Zahlen-Leiste unterm Hero (Exponate, Mitglieder, Bee-Impact), fünf Format-Kacheln als Direkteinstieg (Festpreis bis Service), Auktions-Sektion 'Endet bald' mit tickendem Countdown, Neu-Chip auf Tierbedarf, Kampagnen-Stempel auf der Impact-Box, Gründungsmitglied-Hinweis" },
