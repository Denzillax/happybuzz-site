...
export const REP_LOG = [
  {
    ...
    punkte: [
      { typ: "neu", bereich: "Design", text: "Jedes der fünf Formate hat jetzt seine eigene Farbe: Festpreis Butter, Auktion Lavendel, Miete Himmelblau, Gratis Mint, Service Rosa. Die Kacheln auf der Startseite tragen sie, und die Beschriftung auf jedem Inserat (Festpreis, Auktion und so weiter) hat dieselbe Farbe mit schwarzer Schrift.", melder: "Denis" },
      { typ: "neu", bereich: "Biene", text: "Die Biene hat eine neue Form: flach und von vorn, in Honig mit runden Flügeln, Kugelfühlern, zwei schwarzen Streifen und Stachel. Sie fliegt so über die Seite, hält bei der Challenge der Woche das Megafon und fliegt als Punktbild durch den Schriftzug im Test-Hero. Sie schlägt mit den Flügeln, blinzelt und wippt mit den Fühlern.", melder: "Denis" },
      ...
      { typ: "fix", bereich: "Texte", text: "Texte überarbeitet, damit sie klarer und weniger nach Werbung klingen: Über uns, So funktioniert es, Impact, der Erklärteil der Startseite und die Hilfe. Dabei veraltete Angaben korrigiert: Inserate prüft eine automatische Vorprüfung (nicht mehr wir von Hand), ein Profilbild lässt sich hochladen, das Bee-Level steigt über Pollen und die Stufen heissen Entdecker, Sammler, Hive Builder, Queen Bee und Legende. Die Hilfe sagt jetzt offen, dass es keine Geld-zurück-Garantie gibt, weil direkt an den Verkäufer bezahlt wird", melder: "Denis" },
      { typ: "fix", bereich: "Design", text: "Seitenbreiten vereinheitlicht: Statt zwölf verschiedener Breiten gibt es drei Stufen. Breit (Suche, Inserat, Meine Inserate, Favoriten), normal (Käufe, Verkäufe, Buchungen, Gebote, Bestellung, Hive, Poker, Profil, Einstellungen) und schmal (Inserat erstellen, Bewerben, Import-Helfer). Header, Suchzeile, Seiteninhalt und Footer haben denselben Seitenrand, die linke Kante fluchtet mit dem Logo", melder: "Denis" },
      { typ: "fix", bereich: "Design", text: "Farben nachgeschärft: Fast gleiche Farbtöne sind zusammengelegt (drei Schwarz, zehn Grau für Nebentext, sieben Randfarben, neun helle Flächen). Alles folgt jetzt einer warmen Farbfamilie, vorher mischten sich neutrale und warme Grautöne. Kleiner Hinweistext ist dabei etwas dunkler und besser lesbar geworden", melder: "Denis" },
  ...
  },
  {
    ...
    punkte: [
      { typ: "neu", bereich: "Design", text: "Knöpfe reagieren beim Hovern einheitlich: Die Fläche wird hellgrau, das Symbol wechselt auf Türkis, die Schrift bleibt. Im Header (Kategorien, Inserieren, Kaufen, Favoriten, Glocke, Nachrichten, Konto) bleibt dieser Zustand stehen, solange das Menü offen ist, beim Nachrichten-Symbol solange man im Chat ist. Gleiches gilt für weisse Knöpfe mit Rand auf der ganzen Seite. Nur mit Maus", melder: "Denis" },
      ...
      { typ: "neu", bereich: "Mobil", text: "Am Handy ist alles 8 Prozent grösser: Schrift, Knöpfe, Bilder und Abstände wachsen gleichmässig mit, das Layout bleibt gleich. Am Desktop ändert sich nichts. Dazu ist der Gebotsverlauf am Handy kompakt: ein Gebot pro Zeile mit kleinem Profilbild, Name, Zeit und Betrag", melder: "Denis" },
      { typ: "fix", bereich: "Auktionen", text: "Gebotsfenster ohne Scroll-Leiste: Die Erklärungen (nur so viel wie nötig, 3-Minuten-Verlängerung, Preislimit senken, Sofortkauf-Grenze) stehen jetzt hinter dem Knopf 'So funktioniert es' statt als Fliesstext im Fenster, der AGB-Satz ist auf eine Zeile gekürzt", melder: "Denis" },
      { typ: "fix", bereich: "Inserat", text: "Das Gebotsfenster lag unter dem Header, der Fensterkopf mit Titel und Schliessen war verdeckt. Ursache: Die Fenster sassen in der mitlaufenden rechten Spalte und konnten deren Ebene nicht verlassen. Gebot, Preisvorschlag, QR-Code und Melden hängen jetzt direkt an der Seite und liegen über allem. Das Gebotsfenster ist zudem kompakter, und 'Abbrechen' und 'Bestätigen' bleiben unten stehen, während die Mitte scrollt", melder: "Denis" },
      { typ: "neu", bereich: "Auktionen", text: "Auktionsbox auf dem Inserat überarbeitet: Preis und Restzeit stehen nebeneinander, 'Du führst' und 'überboten' haben ein Symbol, und der Gebotsverlauf ist grösser mit Profilbild, Anzahl Gebote und Bieter und verständlicher Zeit ('vor 2 Std.', 'gestern, 21:40'). Das führende Gebot ist hervorgehoben. Ein Foto sieht man nur vom Führenden und von sich selbst, alle anderen Bieter bleiben anonym", melder: "Denis" },
      { typ: "fix", bereich: "Auktionen", text: "Wurde ein aktives Festpreis-Inserat beim Bearbeiten zur Auktion, fehlte das Enddatum: keine Restzeit auf der Seite, und die Auktion wäre nie beendet worden. Die Datenbank garantiert jetzt, dass jede aktive Auktion ein Ende hat, die betroffene Auktion ist nachgetragen", melder: "Denis" },
      { typ: "neu", bereich: "Effekte", text: "Die Seite antwortet sichtbarer: Das Herz springt beim Merken kurz an, der Preis zählt bei einem neuen Gebot hoch und blitzt in Honig, nach dem Kauf setzt sich ein Stempel 'Gekauft' auf die Bestellung, und im Header zählt der Nektar hoch mit einem aufsteigenden '+N'. Dazu: Inseratkarten blenden beim Scrollen gestaffelt ein, das Zahlenband auf der Startseite zählt hoch, der Auktions-Countdown pulsiert in der letzten Stunde und tickt in der letzten Minute rot, Ladeplatzhalter schimmern, Seiten blenden weich ein, das Kartenbild zoomt ruhiger, und die Hauptknöpfe im Hero ziehen sich minimal zum Mauszeiger. Wer im System 'Bewegung reduzieren' eingestellt hat, sieht keine dieser Bewegungen", melder: "Denis" },
  ...
  },
  {
    ...
    punkte: [
      ...
      { typ: "fix", bereich: "Import", text: "Import-Helfer: Der Text verlor beim Import seine Absätze, jetzt werden Zeilenumbrüche zu Absätzen. Zusätzlich löst der Parser benannte HTML-Codes wie &auml; auf. Die fehlenden Umlaute im PSP-Inserat kamen nicht vom Import (der Text hatte schon an der Quelle keine), sie sind von Hand nachgetragen", melder: "Christian" },
      { typ: "neu", bereich: "Hive", text: "Poker: Texas Hold'em gegen andere Nutzer mit Pollen als Chips, zeitversetzt (12 Stunden pro Zug, Meldung in der Glocke). Tische mit 2 bis 6 Plätzen und Buy-in 20/50/100, Blinds, Erhöhen, All-in, Side-Pots, Showdown mit Blattbewertung, Aufstehen jederzeit (Chips werden wieder Pollen). Der Dealer läuft komplett auf dem Server, Karten sind vor dem Showdown unsichtbar. Einstieg im Hive unter Tägliche Spiele, Reiter Poker", melder: "Denis" },
      { typ: "fix", bereich: "Auktionen", text: "Auktionen mit Geboten liessen sich frei bearbeiten. Jetzt sind Titel, Preise, Auktionsdauer, Typ, Kategorie, Zustand und bestehende Fotos gesperrt, sobald ein Gebot da ist. Erlaubt bleiben ein Nachtrag zur Beschreibung (mit Datum unter dem Original), neue Fotos sowie Versand und Zahlung. Die Datenbank prüft das ebenfalls", melder: "Denis" },
      { typ: "fix", bereich: "Suche", text: "Der KI-Suche-Knopf mit Panel auf der Suchseite ist weg, der Schalter im Suchfeld ersetzt ihn. Eine schmale Zeile zeigt nur noch, wenn die KI gerade sucht oder etwas anmerkt", melder: "Denis" },
      { typ: "fix", bereich: "Suche", text: "Im Suchfeld erschien beim Klick ein durchsichtiger gelber Schein innerhalb der Pille (doppelter Fokus-Rahmen), der ist weg. Neu ein Schalter 'KI an/aus' im Suchfeld (Desktop und mobil, wird gemerkt): an heisst, Enter und Suchen suchen nach der Bedeutung statt nach Wörtern, das Feld wird petrolfarben. Und wer mit ausgeschalteter KI etwas tippt, das wörtlich nichts trifft (etwa 'retro games'), bekommt bei 'Nichts gefunden' den Knopf 'Mit KI suchen'", melder: "Denis" },
      { typ: "neu", bereich: "Hive", text: "Zwei weitere Tagesspiele neben dem Wabenspiel, als Reiter im Block 'Tägliche Spiele': Pollenpfad (Lauf über 10 Felder, pro Schritt sicherer Weg, riskanter Weg oder Ereignisfeld mit Blüte, Regen, Schild oder Wespe; Schild schützt einmal und bleibt bis morgen; erreichte Felder zählen für die Wochenrangliste, Top 3 bekommen montags 50/30/20 Pollen) und Blütenpaar (Memory mit 6 Paaren in 8 Zügen, ab 2 Paaren gibt es etwas zurück, 6 Paare bringen das Dreifache). Jedes Spiel einmal pro Tag, Einsatz 5/10/20 Pollen", melder: "Denis" },
      { typ: "neu", bereich: "Hive", text: "Wabenspiel: einmal pro Tag ein Spiel mit Einsatz (5, 10 oder 20 Pollen). 9 Waben, 7 Honig, 2 Wespen. Jede Honigwabe hebt den Gewinn (1.2x bis 25x), Mitnehmen sichert ihn, eine Wespe frisst den Einsatz. Das Raster wird serverseitig gemischt und erst nach Spielende gezeigt. Einsatz und Gewinn stehen im Pollen-Verlauf", melder: "Denis" },
      ...
      { typ: "neu", bereich: "Chat", text: "Nachrichten kompakter: engere Blasen, Uhrzeit am Zeilenende, Folge-Nachrichten rücken zusammen. Neu ein Emoji-Knopf mit rund 100 Emojis in drei Gruppen (Smileys, Gesten, Handel), reine Emoji-Nachrichten werden gross gezeigt. Die Standard-Schnellantworten sind weg", melder: "Denis" },
      { typ: "fix", bereich: "Auktionen", text: "Beim ersten Gebot verlangte die Maske Startpreis + 1, obwohl der Startpreis selbst gilt. Jetzt reicht der Startpreis, und der Dialog erklärt, dass die Auktion als erster Bieter auf dem Startpreis steht und dein Maximum erst greift, wenn jemand mitbietet", melder: "Christian" },
