...
export const REP_LOG = [
  {
    ...
    punkte: [
      ...
      { typ: "fix", bereich: "Design", text: "Buttons reagieren wieder auf Hover: auf der Inseratseite (Bieten, Sofort kaufen, Favorit, Teilen) sowie auf Startseite, Header und Bannern", melder: "Denis" },
    ],
  },
  {
