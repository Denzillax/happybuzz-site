...
export const REP_LOG = [
  {
    ...
    punkte: [
      ...
      { typ: "neu", bereich: "Inserieren", text: "Neuware mit Varianten und Stückzahl: Bei Zustand Neu (Festpreis) markierst du wählbare Werte (z.B. Grössen S/M/L) und setzt eine Stückzahl. Käufer wählen beim Kauf ihre Variante, jeder Kauf zieht 1 Stück ab und das Inserat bleibt aktiv bis ausverkauft; die Wahl steht auf Bestellung und Rechnung", melder: "Denis" },
