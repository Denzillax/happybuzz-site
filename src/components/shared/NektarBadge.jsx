...
export default function NektarBadge() {
  ...
  return (
    <div ref={ref} className="nektar-badge" style={{ position: "relative" }}>
      ...
      {open && (
        <div style={{ position: "absolute", top: "calc(100% + 8px)", right: 0, zIndex: 200, width: 264, background: "#fff", borderRadius: 12, boxShadow: "0 16px 38px rgba(20,17,13,.16)", border: "1px solid #E4E0D8", padding: 16, fontFamily: "'Manrope', sans-serif" }}>
