  ...
  return (
    <div ref={ref} className="nektar-badge" style={{ position: "relative" }}>
      <button aria-expanded={open} onClick={() => setOpen((o) => !o)} style={{
        ...
        border: "1px solid #1D1D1D", background: "#fff", cursor: "pointer", fontFamily: "'Instrument Sans', 'Manrope', sans-serif",
      }}>
      ...
      {open && (
        <div style={{ position: "absolute", top: "calc(100% + 8px)", right: 0, zIndex: 200, width: 264, background: "#fff", borderRadius: 20, boxShadow: "0 18px 40px -18px rgba(29,29,29,.35)", border: "1px solid #1D1D1D", padding: 16, fontFamily: "'Instrument Sans', 'Manrope', sans-serif" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 12px", borderRadius: 20, background: "#50804F14", border: "1px solid #50804F33", marginBottom: 8 }}>
