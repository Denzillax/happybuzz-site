...
export function BeeLevelCard({ xp = 0, nektar = null }) {
  ...
  return (
    <div style={{
      ...
      border: "1px solid #1D1D1D", padding: "22px 24px",
    }}>
      {/* Level + XP */}
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{
            width: 44, height: 44, borderRadius: 20, border: "1px solid #1D1D1D",
      ...
      {/* Progress Bar */}
      <div style={{
        height: 8, borderRadius: 20, background: colors.borderLt,
        border: `1px solid rgba(29,29,29,.3)`, overflow: "hidden", marginBottom: 8,
      }}>
        <div style={{
