...
import { Search, X, Plus, User, LogOut, ChevronDown, Settings, Tag, ShoppingBag, Star, Receipt, Bell, Menu, Package, UserCheck, MessageCircle, CalendarDays, ShieldCheck, Gavel, AlignJustify, Trophy, Sparkles } from 'lucide-react'
...
export function Header() {
  ...
  return (
    <header style={{ position: 'sticky', top: 0, zIndex: 50 }}>
      ...
      <style>{`
        ...
        @media (max-width: 767px) {
          ...
          /* 375px-Rechnung: Logo 150 + Abstand 16 + Icons 188 = 354, Platz war
             ...
             Achtung: kein Groesser-Zeichen und keine Anfuehrungszeichen in diesem
             style-Block (auch nicht in Selektoren wie [aria-expanded=true]): der
      ...
      <div className="hdr-wrap" style={{ maxWidth: 1280, margin: '0 auto', paddingLeft: 24, paddingRight: 24, position: 'relative' }}>
      ...
      <div className="hdr-searchrow hdr-desktop">
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '4px 24px 10px', width: '100%', boxSizing: 'border-box' }}>
