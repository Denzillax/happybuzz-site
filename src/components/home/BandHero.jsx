...
//  - Die Seite scrollt normal. Das Mausrad wird NICHT umgeleitet, die Bänder laufen von
//    selbst (CSS-Animation) und halten beim Überfahren an.
...
export default function BandHero({ mitSuche = false }) {
  ...
  return (
    <section className="bh" aria-label="Schaufenster">
