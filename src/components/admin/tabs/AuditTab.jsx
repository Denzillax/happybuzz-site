...
export const AUDIT_META = {
  ...
  challenge_created:    { label: "Challenge angelegt",    Icon: Target,      color: "#007C7C", bg: "#E6F5F5" },
  challenge_toggled:    { label: "Challenge (de)aktiviert", Icon: Target,    color: "#CD3800", bg: "#FFF3E0" },
  challenge_updated:    { label: "Challenge-Vorlage geändert", Icon: Target, color: "#007C7C", bg: "#E6F5F5" },
  ...
  feedback_status:      { label: "Feedback-Status geändert", Icon: CheckCircle, color: "#007C7C", bg: "#E6F5F5" },
  feedback_note:        { label: "Feedback-Notiz gespeichert", Icon: Star,   color: "#007C7C", bg: "#E6F5F5" },
  category_create:      { label: "Kategorie angelegt",       Icon: CheckCircle, color: "#2E7D32", bg: "#E8F5E9" },
  category_update:      { label: "Kategorie umbenannt",      Icon: Clock,       color: "#007C7C", bg: "#E6F5F5" },
  category_toggle:      { label: "Kategorie (de)aktiviert",  Icon: Pause,       color: "#CD3800", bg: "#FFF3E0" },
  category_move:        { label: "Kategorie sortiert",       Icon: Clock,       color: "#007C7C", bg: "#E6F5F5" },
  ...
  broadcast:            { label: "Ankündigung gesendet",  Icon: Megaphone,   color: "#007C7C", bg: "#E6F5F5" },
  announcement_bar:     { label: "Banner geändert",       Icon: Megaphone,   color: "#007C7C", bg: "#E6F5F5" },
  company_update:       { label: "Firmendaten geändert",  Icon: Building2,   color: "#007C7C", bg: "#E6F5F5" },
  staff_role_set:       { label: "Mitarbeiter-Rolle gesetzt", Icon: Users2,  color: "#007C7C", bg: "#E6F5F5" },
  ...
  auto_review_toggle:   { label: "Automatische Freigabe umgeschaltet", Icon: ShieldCheck, color: "#007C7C", bg: "#E6F5F5" },
  ...
  ticker:               { label: "Ticker geändert",       Icon: Megaphone,   color: "#007C7C", bg: "#E6F5F5" },
};
