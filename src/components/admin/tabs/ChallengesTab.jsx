  ...
  return (
    <div>
      <div style={{ display: "flex", gap: 6, marginBottom: 16, flexWrap: "wrap", alignItems: "center" }}>
        ...
        <button onClick={() => setShowForm(s => !s)} style={{ marginLeft: "auto", display: "inline-flex", alignItems: "center", gap: 6, padding: "8px 14px", borderRadius: 12, border: "none", background: colors.teal, color: "#fff", fontSize: 12, fontWeight: 700, cursor: "pointer" }}>
      ...
      {showForm && (
        <div style={{ background: "#fff", border: `1px solid ${colors.border}`, borderRadius: radius.lg, padding: 16, marginBottom: 16, display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 12 }}>
          ...
          <div style={{ gridColumn: "1 / -1" }}>
            <button onClick={submit} style={{ padding: "9px 18px", borderRadius: 12, border: "none", background: colors.teal, color: "#fff", fontSize: 12.5, fontWeight: 700, cursor: "pointer" }}>
                ...
                <td style={{ ...td, textAlign: "center" }}>
                  <div style={{ display: "flex", gap: 4, justifyContent: "center" }}>
                    ...
                    <button onClick={() => toggleChallenge(c)} title={c.active ? "Deaktivieren" : "Aktivieren"}
                      style={{ padding: "4px 10px", borderRadius: 12, border: "none", background: c.active ? "#FFF3E0" : "#E8F5E9", color: c.active ? "#E65100" : "#2E7D32", fontSize: 10, fontWeight: 700, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 3 }}>
                    ...
                    <button onClick={() => { if (confirm(`"${c.title}" wirklich löschen?${c.participants > 0 ? ` ${c.participants} Teilnahme(n) werden mitgelöscht (gutgeschriebene Pollen bleiben).` : ""}`)) deleteChallenge(c); }}
                      title="Löschen"
                      style={{ padding: "4px 10px", borderRadius: 12, border: "none", background: "#FFEBEE", color: "#c62828", fontSize: 10, fontWeight: 700, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 3 }}>
