            ...
            <div key={f.id} style={{ padding: "13px 16px", borderBottom: `1px solid ${colors.borderLt}`, background: st === "resolved" || st === "wontfix" ? "#fafafa" : "transparent", opacity: st === "wontfix" ? 0.65 : 1 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4, flexWrap: "wrap" }}>
                ...
                <select value={st} onChange={e => setFeedbackStatus(f.id, e.target.value)}
                  style={{ border: `1px solid ${colors.border}`, borderRadius: 10, padding: "5px 8px", fontSize: 11, fontFamily: fonts.body, background: "#fff", cursor: "pointer", flexShrink: 0 }}>
              ...
              <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                <input value={draft} onChange={e => setNoteDraft(p => ({ ...p, [f.id]: e.target.value }))}
                  ...
                  style={{ flex: 1, border: `1px solid ${colors.border}`, borderRadius: 10, padding: "6px 10px", fontSize: 12, fontFamily: fonts.body, outline: "none", background: "#fff", boxSizing: "border-box" }} />
