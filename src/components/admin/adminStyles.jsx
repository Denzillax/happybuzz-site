...
export const th = { padding: "11px 14px", fontSize: 9.5, fontWeight: 700, color: "#7D848E", textTransform: "uppercase", letterSpacing: ".05em", textAlign: "left", fontFamily: fonts.body };
...
export const bcFieldLabel = { fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: ".05em", color: "#7D848E", marginBottom: 4 };
