...
export const th = { padding: "11px 14px", fontSize: 9.5, fontWeight: 700, color: "#686E78", textTransform: "uppercase", letterSpacing: ".05em", textAlign: "left", fontFamily: fonts.body };
export const td = { padding: "12px 14px", fontSize: 12.5, fontFamily: fonts.body };
export const pill = (bg, color, label) => <span style={{ padding: "2px 9px", borderRadius: 12, fontSize: 10, fontWeight: 700, background: bg, color }}>{label}</span>;
export const bcFieldLabel = { fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: ".05em", color: "#686E78", marginBottom: 4 };
export const bcInput = { width: "100%", boxSizing: "border-box", border: "1px solid #E5E8EC", borderRadius: 12, padding: "9px 12px", fontSize: 13, fontFamily: fonts.body, color: "#191615", outline: "none" };
export const chartCard = { border: `1px solid ${colors.border}`, borderRadius: 12, padding: 14, background: "#fff" };
