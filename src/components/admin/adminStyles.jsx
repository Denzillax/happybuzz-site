...
export const pill = (bg, color, label) => <span style={{ padding: "2px 9px", borderRadius: 10, fontSize: 10, fontWeight: 700, background: bg, color }}>{label}</span>;
export const bcFieldLabel = { fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: ".05em", color: "#999", marginBottom: 4 };
export const bcInput = { width: "100%", boxSizing: "border-box", border: "1px solid #E2E2E2", borderRadius: 10, padding: "9px 12px", fontSize: 13, fontFamily: fonts.body, color: "#191615", outline: "none" };
export const chartCard = { border: `1px solid ${colors.border}`, borderRadius: 10, padding: 14, background: "#fff" };
