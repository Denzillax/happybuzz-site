...
export const pill = (bg, color, label) => <span style={{ padding: "2px 9px", borderRadius: 20, fontSize: 10, fontWeight: 700, background: bg, color }}>{label}</span>;
...
export const chartCard = { border: `1px solid ${colors.border}`, borderRadius: 14, padding: 14, background: "#fff" };
