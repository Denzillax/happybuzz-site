...
export default function ImportBox({ onImport }) {
  ...
  if (done) {
    return (
      <div style={{ background: "#DBF5F0", border: "1px solid #50804F", borderRadius: 20, padding: "12px 18px", marginBottom: 20 }}>
        <p style={{ margin: 0, fontSize: 13, fontWeight: 700, color: "#50804F", fontFamily: fonts.body, display: "flex", alignItems: "center", gap: 7 }}>
  ...
  if (busy) {
    return (
      <div style={{ background: "#fff", border: "1px solid #1D1D1D", borderRadius: 20, padding: "12px 18px", marginBottom: 20 }}>
  ...
  return (
    ...
    <div className="import-promo" style={{ background: "#fff", border: "1px solid #1D1D1D", borderRadius: 20, padding: "12px 18px", marginBottom: 20 }}>
