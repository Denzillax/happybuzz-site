...
function ServiceInvoiceEditor({ purchaseId, sellerId, feePercent = 5, onSubmitted }) {
  ...
  const inputStyle = {
    padding: "9px 12px", border: "1px solid #E4E0D8", borderRadius: 10,
            ...
            {INVOICE_TEMPLATES.map(t => {
              ...
              return (
                <button key={t.key} onClick={() => addItem(t)} style={{
                  ...
                  cursor: "pointer", borderRadius: 10, transition: "background .1s",
                ...
                >
                  <div style={{ width: 28, height: 28, borderRadius: 10, background: colors.cream, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
