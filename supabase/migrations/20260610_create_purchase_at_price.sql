-- Ueberladene Kauf-RPC mit vereinbartem Preis (fuer akzeptierte Preisvorschlaege).
-- Spiegelt create_purchase(uuid,uuid), nutzt aber p_price wenn > 0.
...
grant execute on function public.create_purchase(uuid, uuid, numeric) to authenticated, anon;
